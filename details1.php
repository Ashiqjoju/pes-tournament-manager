<!doctype html>
 <head>
  ...
  color:white;
                				...
                				<span class="tabs-text" styel="">Make a Deal</span></li>
...
<?php
   ...
   else
   {
    ...
    $cteamc = $row['team'];
      ...
      elseif($cteam=='atm')
      {
        $cteam= 'ATLETICO MADRID';
      }
      elseif($cteam=='chelsea')
      {
        $cteam= 'CHELSEA';
      }
      elseif($cteam=='arsenal')
      {
        $cteam= 'ARSENAL';
      }
      elseif($cteam=='barca')
  ...
  background-color: #E8AD23;
    ...
    <div class="container"> 
       <div class="tab">
        ...
        </ul><form action="transferform.html" method="get">
        <div class="add">
        <input type="hidden" name="namep" value="<?= $row['player']?>">
        <input type="hidden" name="image" value="<?= $row['player_img']?>">
        <input type="hidden" name="cteam" value="<?= $cteamc ?>" >
        <input type="hidden" name="mteam" value="<?= $myteam ?>">
        	
          <button type="submit" name="button">Make a Deal</button>
       </form>
        </div>
