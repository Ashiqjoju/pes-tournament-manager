            ...
            <div  class="VerticalTab VerticalTab_hash_scroll VerticalTab_6 tabs_ver_6">
              ...
              <ul class="resp-tabs-list hor_1" >
               ...
               <li class="tabs-1" data-tab-name="profile">
                ...
                <li class="tabs-3" data-tab-name="portfolio"><span class="tabs-text"></span></li>             
...
<tr>
								...
								<td id='aaa' >
												<center><img style='padding:10px; width:90%' src='img/".$res['team'].".png' width='3px'>
								</td>
								<td>
											<center><img style='padding:10px;width:40%' src='arrow1.jpg' width='10%'>
								</td>
								<td id='aaa'>
											<center><img style='padding:10px; width:90%'  src='img/".$res['rumours'].".png' width='100%'>
								</td>
				</tr>
...
<div class="container">
 ...
 <!-- <div class="alert alert-success">
    <strong>Success!</strong> Player has been added to wishlist, Login to see changes.
  </div>
  -->
