 <?php
{
   ...
   {
   $result=mysqli_query($conn,"SELECT * FROM users ORDER BY goal DESC ");
   }
...
<body class="is-boxed has-animations">
    <div class="body-wrap">
        ...
        <center>
          ...
          <h1 class="m-0" style="color:#8A94A7">GOLDEN BOOT</h1>
...
<tr><th colspan="2"><!-- <marquee style="color:black; font-family: Monaco; Font-size:12px;background:white;">Paris Saint Germain Won the Golden Boot of MML Season-1.</marquee> --></th></tr>
                               ...
                               <td><center> ".$res['goal']." </center></td>
                                                          </tr>
                               "; 
                               }
                               ?>
                             
                              <tr><td colspan="2"><center><span style="font-size:10px">Golden Boot table will be updated at weekends</span></center></td></th>
