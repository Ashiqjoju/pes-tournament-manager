 <?php
{
   ...
   {
   $result=mysqli_query($conn,"SELECT * FROM mml ORDER BY point DESC ");
   }
...
<body class="is-boxed has-animations">
    <div class="body-wrap">
        ...
        <center>
          ...
          <h1 class="m-0" style="color:#8A94A7">GOLDEN BALL</h1>
            ...
            <section class="pricing section">
               ...
               <div class="container-sm">
					...
					<div>				
                                                ...
                                                <table border="0" cellspacing="30px" class="table"  style="width:350px">
...
<tr >
<th colspan="2" > <marquee style="color:black; font-family: Monaco; font-size:12px;background:white;">Manchester United won the Golden Ball of MML Season-1.</marquee></th>
            ...
            </span><center> <p style="font-size:10px">GD<span style="color:red">*</span> Goal Difference</p></center>
